...
class SettingsWindow(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.light_button_up = tk.Button(self, image = self.uparrow, bg = "#424242", height=60, width=45, bd='1', command=self.inc_light)
        self.light_button_up.place(y=113, x=630)
        ...
        self.temp_button_up = tk.Button(self, image = self.uparrow, bg = "#424242", height=60, width=45, bd='1', command=self.inc_temp)
        self.temp_button_up.place(y=276, x=630)
        ...
        self.left_p_button_up = tk.Button(self, image = self.uparrow, bg = "#424242", height=60, width=45, bd='1', command=self.inc_p_left)
        self.left_p_button_up.place(y=69, x=250)

        self.right_p_button_down = tk.Button(self, image = self.downarrow, bg = "#424242", height=60, width=45, bd='1', command=self.dec_p_right)
        self.right_p_button_down.place(y=149, x=320)
        self.right_p_button_up = tk.Button(self, image = self.uparrow, bg = "#424242", height=60, width=45, bd='1', command=self.inc_p_right)
        self.right_p_button_up.place(y=149, x=250)

        self.top_p_button_down = tk.Button(self, image = self.downarrow, bg = "#424242", height=60, width=45, bd='1', command=self.dec_p_top)
        self.top_p_button_down.place(y=229, x=320)
        self.top_p_button_up = tk.Button(self, image = self.uparrow, bg = "#424242", height=60, width=45, bd='1', command=self.inc_p_top)
        self.top_p_button_up.place(y=229, x=250)

        self.bottom_p_button_down = tk.Button(self, image = self.downarrow, bg = "#424242", height=60, width=45, bd='1', command=self.dec_p_bottom)
        self.bottom_p_button_down.place(y=309, x=320)
        self.bottom_p_button_up = tk.Button(self, image = self.uparrow, bg = "#424242", height=60, width=45, bd='1', command=self.inc_p_bottom)
        self.bottom_p_button_up.place(y=309, x=250)
